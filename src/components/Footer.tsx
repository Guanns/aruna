        ...
        <footer className="bg-[#FFFBF5] pt-20 pb-10 border-t border-[#6B4F4F]/5 relative overflow-hidden font-sans">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="border-t border-[#6B4F4F]/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex items-center gap-2 text-sm text-[#6B4F4F]/60 font-medium bg-white/50 px-4.5 py-2 rounded-full border border-[#6B4F4F]/5">
                        <span>Menemukan BUG? Hubungi kami melalui</span>
                        <a 
                            href={`https://wa.me/6285822621031?text=${encodeURIComponent(
                                "Halo tim Aruna, saya menemukan bug pada aplikasi. Berikut rincian bug tersebut:\n\n- Fitur/Halaman: \n- Deskripsi Bug: \n- Langkah Reproduksi: "
                            )}`}
                            target="_blank" 
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-1.5 text-green-600 hover:text-green-700 transition-colors font-bold group"
                            title="Laporkan Bug via WhatsApp"
                        >
                            <svg className="w-4.5 h-4.5 text-green-500 fill-current group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
                                <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946C.06 5.348 5.397.01 12.008.01c3.202.001 6.212 1.246 8.477 3.514 2.266 2.268 3.507 5.28 3.505 8.484-.004 6.657-5.34 11.997-11.953 11.997-2.005-.001-3.973-.502-5.724-1.455L0 24zm6.59-4.846c1.6.95 3.188 1.449 4.825 1.451 5.436 0 9.86-4.37 9.864-9.799.002-2.63-1.023-5.101-2.885-6.963C16.528 2.017 14.077.99 11.45.99c-5.436 0-9.861 4.371-9.865 9.8.001 1.716.452 3.39 1.308 4.877L1.85 20.25l4.797-1.096zM17.51 14.88c-.29-.145-1.71-.845-1.975-.94-.266-.096-.46-.145-.653.146-.193.29-.747.94-.916 1.132-.17.194-.339.219-.63.075-.29-.145-1.223-.45-2.33-1.439-.86-.767-1.44-1.716-1.61-2.007-.17-.29-.018-.447.127-.59.13-.13.29-.34.435-.508.145-.17.193-.29.29-.483.097-.193.048-.361-.025-.508-.072-.145-.653-1.573-.894-2.153-.236-.569-.472-.49-.653-.5h-.557c-.193 0-.508.073-.774.362-.266.29-1.014.992-1.014 2.42 0 1.43 1.04 2.81 1.185 3 .145.19 2.05 3.13 4.965 4.39.693.3 1.233.479 1.654.613.697.22 1.33.19 1.83.115.557-.08 1.71-.698 1.95-1.374.24-.677.24-1.258.17-1.376-.073-.118-.266-.19-.557-.335z"/>
                            </svg>
